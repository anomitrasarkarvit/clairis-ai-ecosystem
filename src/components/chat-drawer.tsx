        ...
        <DrawerHeader className="border-b border-border/50 bg-card/5 backdrop-blur-md">
          <div className="flex items-center justify-between w-full">
            <div className="flex items-center gap-2">
              ...
              <DrawerTitle className="text-xl font-bold font-rajdhani">CLAIRIS Chat</DrawerTitle>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              {messages.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <h2 className="text-xl font-semibold mb-2">Welcome to CLAIRIS</h2>
                ...
                <div className="flex gap-4 justify-start">
                  ...
                  <div className="bg-card/50 border border-border/50 rounded-2xl px-4 py-3">
                    <div className="flex gap-1">
                      ...
                      <div className="w-2 h-2 bg-aurora-primary/60 rounded-full animate-bounce" style={{animationDelay: '0.1s'}}></div>
                      <div className="w-2 h-2 bg-aurora-primary/60 rounded-full animate-bounce" style={{animationDelay: '0.2s'}}></div>
                    </div>
                  </div>
                </div>
              )}
